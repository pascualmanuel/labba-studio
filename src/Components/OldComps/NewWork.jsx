...
const Works = () => {
  ...
  return (
    <>
      <div>
        <section className="works-section relative  mx-auto px-6 sm:px-[53px]  lg:px-16 max-w-[1500px] ">
        ...
        <section
          className={`mx-auto px-6 sm:px-[53px] lg:px-16 sm:pt-5 max-w-[1500px] transition-transform duration-500 ${
