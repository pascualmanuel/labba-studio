...
const About = () => {
  ...
  return (
    <>
      <div id={shadowOn}></div>
      <div
        className="about-page flex items-center justify-center"
        style={{
          height: "720px",
        }}
      >
        <h3 className="md:text-[120px] text-[54px] md:leading-[108%] leading-[103%] md:tracking-[-0.03em] tracking-[-0.02em] text-[#FFFFFF] font-bold">
      ...
      >
        <p className="text-[#E2E2E2] text-[16px] leading-[22px] md:text-[18px] md:leading-[22px] md:max-w-[575px]">
          ...
          experience working with companies big and small, across industries and
          time zones. We started Labba because we love building brands and
          digital products that actually work, that matter, and that stick.
          <br />
          <br />
          We know what it's like to launch fast, iterate faster, and still keep
          the quality high. We've worked with early-stage startups chasing
          product-market fit, and with established companies needing clarity,
          design precision, and reliable execution. No matter the size or stage,
          we treat every project like it's our own—because that's how we build
          the best stuff.
          <br />
          <br />
          Our team is made up of creatives and strategists from all over the
          world. We've helped shape products and experiences in industries like
          fintech, SaaS, health, retail, AI, and more. We adapt like lava—moving
          with purpose, finding the best path forward, and never losing
          momentum.
          <br />
          <br />
